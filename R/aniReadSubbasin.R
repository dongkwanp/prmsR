#' aniRead for Subbasins
#'
#' This is a modification of the aniRead function to work with nsub instead of nHRUs.
#'
...
aniReadSubbasin <- function(output.filepath = paste0(getwd(), '/output/output.out.nsub')) {
  ...
  for (i in 1:max(import.data$nsub)) {
