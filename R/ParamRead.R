#' Read parameter file for PRMS
#'
#' Functionalization o the script
#'
#' @param prms.param.path File Path and File Name for Parameter File
#' @param verbose Verbose flag
#'
#' @return Object with Parameter Value
#' @export

ParamRead <- function(prms.param.path, verbose = FALSE) {
  # Importing File into Memory (Note: Don't use this for large files)
  param.con <- file(prms.param.path, "r")
